...
namespace EnhancedDistrictServices.Serialization
{
    ...
    /// </summary>
    public class EnhancedDistrictTransferHistorySerializableData : SerializableDataExtensionBase
    {
        ...
        public bool TryLoadData<T>(string id, SerializationBinder binder, out T target) where T : class
        {
            ...
            Logger.Log($"EnhancedDistrictTransferHistorySerializableData::LoadData: version {id}");
            ...
            try
            {
                ...
                if (target == null)
                {
                    Logger.LogWarning($"EnhancedDistrictTransferHistorySerializableData::LoadData: Data failed to load version {id}");
                }
        ...
        {
            Logger.Log($"EnhancedDistrictTransferHistorySerializableData::SaveData: version {id}");
